...
import { idlFactory } from './hodlprotocol_exchange.did.js';
export { idlFactory } from './hodlprotocol_exchange.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HODLPROTOCOL_EXCHANGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hodlprotocol_exchange.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hodlprotocol_exchange canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hodlprotocol_exchange.did.js")._SERVICE>}
 */
export const hodlprotocol_exchange = createActor(canisterId);
