...
import { idlFactory } from './hodlhut_backend.did.js';
export { idlFactory } from './hodlhut_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HODLHUT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hodlhut_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hodlhut_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hodlhut_backend.did.js")._SERVICE>}
 */
export const hodlhut_backend = createActor(canisterId);
