...
import { idlFactory } from './hodlhut_frontend.did.js';
export { idlFactory } from './hodlhut_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_HODLHUT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hodlhut_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hodlhut_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hodlhut_frontend.did.js")._SERVICE>}
 */
export const hodlhut_frontend = createActor(canisterId);
